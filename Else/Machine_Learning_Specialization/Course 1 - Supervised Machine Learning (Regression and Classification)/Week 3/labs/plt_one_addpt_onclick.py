...
class plt_one_addpt_onclick:
    ...
    def __init__(self, x, y, w, b, logistic=True):
        ...
        # self.resize_sq(self.bthresh)  # Commented out to avoid matplotlib compatibility issues
...
#   @output.capture()  # debug
    ...
    def resize_sq(self, bcid):
        ...
        # Check if rectangles attribute exists (for newer matplotlib versions)
        ...
        bcid.lines[0][1].set_ydata([ymin,ymax])
            ...
            # For newer matplotlib versions, skip the resize operation
            pass
