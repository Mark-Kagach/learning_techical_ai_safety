...
1. Solve an advanced real problem with frontier ML techniques (e.g. winning a hackathon, or personal project). For details see level 3-4 project [here](https://www.youtube.com/watch?v=Bx4BYXOE9SQ&t=186s).
...
1. XYZNAME I SHOULD LINK Where I upload my ≈daily flashcard practices and [feynman lessons](https://www.youtube.com/watch?v=_f-qkGJBPts) explaining whatever important concepts I'm trying to learn.
2. XYZNAME I SHOULD LINK And right now as a beginner, I practice ML techniques through execrises of Hands-on ML book by Geron Aurelien.

## Details
All of this is public because I want to show __consistency and seriousness__ I apply to getting better (I also perform better with public accountability).
